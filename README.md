...
> **⚑ 정본 전략 = [docs/question-types.html](docs/question-types.html)**
> (2026-08-02 확정). 질문을 QT1~4로 분류하고, spec 존(QT1/2)을 넓히며 agent
> 존(QT4)을 승격 루프로 좁힌다. **모든 설계·이슈·구현은 이 문서의 §0 전략
> 선언·§8 운영 루프에 정렬한다** — 충돌하면 이 문서가 이긴다.
