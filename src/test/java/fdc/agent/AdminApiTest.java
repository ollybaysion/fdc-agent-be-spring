...
class AdminApiTest {
    ...
    @Test
    void akg_미구성이면_reloaded_false로_정직하게_보고한다() throws Exception {
        ...
        assertThat(body.path("skills").path("reloaded").asBoolean()).isFalse();
        ...
        assertThat(body.path("lines").path("reloaded").asBoolean()).isFalse();
